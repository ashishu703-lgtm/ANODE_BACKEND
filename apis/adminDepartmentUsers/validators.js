...
const createUserSchema = Joi.object({
  ...
  departmentType: Joi.string().valid('telesales', 'marketing_sales', 'office_sales').required(),
...
const updateUserSchema = Joi.object({
  ...
  departmentType: Joi.string().valid('telesales', 'marketing_sales', 'office_sales').optional(),
